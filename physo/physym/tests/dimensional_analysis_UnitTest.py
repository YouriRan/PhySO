...
def hard_test_case():
    ...
    # TEST PROGRAM
    test_program_str = [
        "mul", "mul", "M", "n2", "c", "sub", "inv", "sqrt", "sub", "const1", "div", "n2", "v", "n2", "c", "cos", "div",
        "sub", "div", "const1", "const1", "div", "v", "c", "div", "v", "c"
    ]
    ...
    expected_constraints = np.array([
        ...
        (
            ...
            [1., -1., 0., 0., 0., 0., 0.],
                                    ...
                                    dtype=object)
    expected_tokens_cases_record = np.array(
        [3, 70, 21, 72, 21, 73, 4, 5, 5, 4, 1, 70, 21, 73, 5, 1, 6, 70, 21, 21, 72, 20, 70, 73, 73, 70, 73])
...
class DimensionalAnalysisTest(unittest.TestCase):
    ...
    def test_get_required_units(self):
        ...
        try:
            ...
            my_programs = Prog.VectPrograms(batch_size=batch_size_large,
                                            max_time_step=test_program_length,
                                            library=my_lib)
        ...
        bool_works = np.array_equal(observed_phy_units_final_w_step_from_scratch,
                                    observed_phy_units_final_w_step,
                                    equal_nan=True)
        self.assertEqual(bool_works, True)
        bool_works = np.array_equal(observed_is_constraining_final_w_step_from_scratch,
                                    observed_is_constraining_final_w_step)
        self.assertEqual(bool_works, True)
