...
class VectProgramsTest(unittest.TestCase):
    ...
    def test_family_relationships(self):
        ...
        # TEST PROGRAM
        test_program_str = [
            "mul", "mul", "M", "n2", "c", "sub", "inv", "sqrt", "sub", "c1", "div", "n2", "v", "n2", "c", "cos", "div",
            "sub", "const1", "div", "v", "c", "div", "v", "c"
        ]
    ...
    def test_units_related(self):
        ...
        n = np.NAN
        expected_units_analysis_cases = np.array([[n, n, n, n, n, n, o], [n, n, n, n, n, n, n], [n, n, n, n, n, o, o]])
