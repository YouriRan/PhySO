...
class TokenTest(unittest.TestCase):
    ...
    def test_token_operation_creation_exceptions(self):
        ...
        with self.assertRaises(AssertionError):
            add = Tok.Token(name='add', sympy_repr='add', arity=2, complexity=0, var_type=0, function=None, var_id=None)
        # Test exception: var_id is supposed to be Nan
        with self.assertRaises(AssertionError):
            add = Tok.Token(name='add', sympy_repr='add', arity=2, complexity=0, var_type=0, function=np.add, var_id=0)
        # Test exception: arity is supposed to be >= 0
        with self.assertRaises(AssertionError):
            x0 = Tok.Token(name='x0', sympy_repr='x0', arity=-1, complexity=0, var_type=1, function=None, var_id=0)
    ...
    def test_token_input_var_creation(self):
        # Test token creation
        try:
            x0 = Tok.Token(name='x0', sympy_repr='x0', arity=0, complexity=0, var_type=1, function=None, var_id=0)
        except:
            self.fail("Token creation failed")
    ...
    def test_token_name_too_long(self):
        ...
        with self.assertRaises(AssertionError):
            add = Tok.Token(name=too_large_name,
                            sympy_repr='add',
                            arity=2,
                            complexity=0,
                            var_type=0,
    ...
    def test_token_creation_units(self):
        try:
            physical_quantity = Tok.Token(name='x0',
                                          sympy_repr='x0',
                                          arity=0,
                                          complexity=0,
                                          var_type=1,
